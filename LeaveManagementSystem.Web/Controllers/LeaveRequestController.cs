                                    ...
                                    ,ILeaveRequestsService _leaveRequestsService) : Controller
{
    ...
    public async Task<IActionResult> Create(int? leaveTypeId)
    {
        ...
        var leaveTypesLists = new SelectList(leaveTypes, "Id", "Name", leaveTypeId);
    ...
    {
        //var model = await _leaveRequestsService.GetLeaveRequestForReview(id);
        await _leaveRequestsService.ReviewLeaveRequests(id, approved);
        return RedirectToAction(nameof(AllLeaveRequestsList));
    }
